...
| Q026 | shared-reference hypothesis | compare broker-default EMA/MACD/VWAP references against nearby matched perturbations/placebos | OPEN / DESIGN ONLY | required before attributing any response to shared trader visibility |
